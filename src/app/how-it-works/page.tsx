...
export const metadata: Metadata = {
  title: "How it works — Cryptonichub",
  description: "How trading Volatility Indices on Cryptonichub works: markets, contracts, deposits and withdrawals.",
};
  ...
  return (
    ...
    >
      ...
      <Section heading="5. Withdraw your winnings">
        <p>
          Withdrawals are <b>instant</b> to M-Pesa. Because Cryptonichub is a trading platform (not a
      ...
      <Section heading="A note on risk">
        <p>
          ...
          lose, and set yourself limits. Cryptonichub is for entertainment and speculative trading.
        </p>
      </Section>
    </InfoPage>
  );
