// Cryptonichub service worker — minimal and safe. It ONLY provides an offline
...
self.addEventListener("push", (event) => {
  ...
  try {
    ...
    data = { title: "Cryptonichub", body: event.data ? event.data.text() : "" };
  }
  const title = data.title || "Cryptonichub";
  const options = {
    body: data.body || "",
    icon: "/apple-icon",
    badge: "/icon.svg",
